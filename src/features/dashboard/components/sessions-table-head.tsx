  ...
  return (
    <TableHeader className="bg-transparent">
      <TableRow className="border-border/40 hover:bg-transparent">
        ...
        <TableHead className="w-16 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6 hidden sm:table-cell">#</TableHead>
        <TableHead className="w-24 md:w-32 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">Date</TableHead>
        <TableHead className="w-32 md:w-40 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">Séance</TableHead>
        <TableHead aria-sort={ariaSortFor('duration', sortConfig)} className="w-20 md:w-24 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">
          <button
        ...
        <TableHead aria-sort={ariaSortFor('distance', sortConfig)} className="w-20 md:w-24 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">
          <button
        ...
        <TableHead aria-sort={ariaSortFor('avgPace', sortConfig)} className="w-20 md:w-24 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">
          <button
        ...
        <TableHead aria-sort={ariaSortFor('avgHeartRate', sortConfig)} className="w-20 md:w-24 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">
          <button
        ...
        <TableHead aria-sort={ariaSortFor('perceivedExertion', sortConfig)} className="w-20 md:w-24 whitespace-nowrap text-center text-[10px] md:text-[11px] font-bold uppercase tracking-[0.12em] md:tracking-[0.15em] text-muted-foreground/60 py-4 md:py-6">
          <button
