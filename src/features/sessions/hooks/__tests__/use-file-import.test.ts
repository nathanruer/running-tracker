...
describe('useFileImport', () => {
  ...
  describe('CSV Import', () => {
    it('should parse CSV file and update form values', async () => {
      const mockCSVData = {
        steps: [
          { stepNumber: 1, stepType: 'effort' as const, duration: '00:02:00', distance: null, pace: '04:00', hr: null },
          { stepNumber: 2, stepType: 'recovery' as const, duration: '00:01:00', distance: null, pace: '05:30', hr: null },
        ],
        repetitionCount: 5,
