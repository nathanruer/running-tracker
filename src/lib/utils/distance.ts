/**
 * Distance estimation and validation utilities
 */
 ...
 *
 * @param durationSec Duration in seconds
 * @param paceSec Pace in seconds per km (null if unknown)
 * @param recordedDistance Recorded/target distance in km (null if unknown)
 * @param config Estimation configuration
 * @returns Distance estimation result
 */
 ...
 * @param distanceKm Recorded distance in km
 * @param paceMinPerKm Pace string like "5:00"
 * @returns Adjusted distance if needed, or original
 */
