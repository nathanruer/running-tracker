            ...
            <FormItem>
              ...
              {!isCustomType ? (
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="SEUIL, VMA..." />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center rounded-md border p-1 bg-background/50 h-8">
              <Button
                type="button"
                variant={effortMode === 'time' ? 'secondary' : 'ghost'}
                size="sm"
                onClick={() => setEffortMode('time')}
              ...
              <Button
                type="button"
                variant={effortMode === 'distance' ? 'secondary' : 'ghost'}
                size="sm"
                onClick={() => setEffortMode('distance')}
                className="h-6 text-xs px-2"
              >
                Dist.
              </Button>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center rounded-md border p-1 bg-background/50 h-8">
              <Button
                type="button"
                variant={recoveryMode === 'time' ? 'secondary' : 'ghost'}
                size="sm"
                onClick={() => setRecoveryMode('time')}
                className="h-6 text-xs px-2"
              >
                Temps
              </Button>
              <Button
                type="button"
                variant={recoveryMode === 'distance' ? 'secondary' : 'ghost'}
                size="sm"
                onClick={() => setRecoveryMode('distance')}
                className="h-6 text-xs px-2"
              >
                Dist.
              </Button>
